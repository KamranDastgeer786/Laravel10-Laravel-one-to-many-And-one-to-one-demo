        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="{{ route('user.index') }}" class="dropdown-item">View User List</a>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="{{ route('products.index') }}" class="dropdown-item">View Product List</a>
                    <a href="{{ route('products.create') }}" class="dropdown-item">Create New Product</a>
                </div>
            </div>

            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="bi bi-view-list me-2"></i>Category</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="{{ route('category.index') }}" class="dropdown-item">View Category List</a>
                    <a href="{{ route('category.create') }}" class="dropdown-item">Create New Category</a>
                </div>
            </div>
